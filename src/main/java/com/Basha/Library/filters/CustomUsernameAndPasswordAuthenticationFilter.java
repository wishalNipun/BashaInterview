package com.Basha.Library.filters;
...
public class CustomUsernameAndPasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        try {
            ...
            com.Basha.Library.util.mapping.User user = (com.Basha.Library.util.mapping.User) authResult.getPrincipal();
            TokenDTO tokenDTO = jwtUtil.getTokensDTO(user.getEmail(), loggingDate);
